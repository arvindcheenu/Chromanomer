...
You can use either the `40 MB coxy.scss file` or the `455 MB ./css/coxy.css file` for your development purposes. Since both of these files are humongous in size,  **usage of `purgecss` is highly recommended** to remove unused css from your production build to drastically reduce your filesize.
